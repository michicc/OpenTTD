...
static const char *_frag_shader_rgb_mask_blend[] = {
	...
	"  gl_FragData[0].rgb = idx > 0 ? adj_brightness(remap_col.rgb, max3(rgb_col.rgb)) : rgb_col.rgb;",
	"}",
};
...
static const char *_frag_shader_rgb_mask_blend_150[] = {
	...
	"  colour.rgb = idx > 0 ? adj_brightness(remap_col.rgb, max3(rgb_col.rgb)) : rgb_col.rgb;",
	"}",
};
