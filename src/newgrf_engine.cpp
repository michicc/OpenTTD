...
static uint32 VehicleGetVariable(Vehicle *v, const VehicleScopeResolver *object, byte variable, uint32 parameter, bool *available)
{
	...
	switch (variable - 0x80) {
		...
		case 0x52: return ClampToI32(v->GetConsist() != NULL ? v->GetConsist()->GetDisplayProfitThisYear() : 0);
		case 0x53: return GB(ClampToI32(v->GetConsist() != NULL ? v->GetConsist()->GetDisplayProfitThisYear() : 0),  8, 24);
		case 0x54: return GB(ClampToI32(v->GetConsist() != NULL ? v->GetConsist()->GetDisplayProfitThisYear() : 0), 16, 16);
		case 0x55: return GB(ClampToI32(v->GetConsist() != NULL ? v->GetConsist()->GetDisplayProfitThisYear() : 0), 24,  8);
		case 0x56: return ClampToI32(v->GetConsist() != NULL ? v->GetConsist()->GetDisplayProfitLastYear() : 0);
		case 0x57: return GB(ClampToI32(v->GetConsist() != NULL ? v->GetConsist()->GetDisplayProfitLastYear() : 0),  8, 24);
		case 0x58: return GB(ClampToI32(v->GetConsist() != NULL ? v->GetConsist()->GetDisplayProfitLastYear() : 0), 16, 16);
		case 0x59: return GB(ClampToI32(v->GetConsist() != NULL ? v->GetConsist()->GetDisplayProfitLastYear() : 0), 24,  8);
