 ...
 */
OrderBackup::OrderBackup(const Consist *cs, uint32_t user)
{
	Vehicle *v = cs->Front();
 ...
 */
/* static */ void OrderBackup::Backup(const Consist *cs, uint32_t user)
{
 ...
 */
/* static */ void OrderBackup::Restore(Consist *cs, uint32_t user)
{
	for (OrderBackup *ob : OrderBackup::Iterate()) {
