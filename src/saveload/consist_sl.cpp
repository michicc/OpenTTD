...
{
	if (IsSavegameVersionUntil(SLV_CONSISTS)) return;
...
/** Chunk handler for vehicle consists. */
extern const ChunkHandler _consist_chunk_handlers[] = {
	{ 'CNST', Save_CNST, Load_CNST, Ptrs_CNST, nullptr, CH_ARRAY | CH_LAST},
};
