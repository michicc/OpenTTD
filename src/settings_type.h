...
struct CargodestSettings {
	uint8  base_town_links[2];               ///< minimum number of town demand links for pax/mail and for all other cargoes
	uint8  base_ind_links[3];                ///< minimum number of industry demand links for cargoes with town effect, symmetric cargoes, and all other cargoes
	...
	uint32 big_town_pop[2];                  ///< passenger and mail amounts to count as a big town
	uint8  random_dest_chance;               ///< percentage of traffic for random destination
};
