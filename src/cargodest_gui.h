 ...
 */
 ...
 /** @file cargodest_gui.h GUI functions related to the cargodest GUI. */
...
class CargoDestinationList {
	...
	void RebuildList();
	void SortList();
	StringID PrepareDisplayString(const GUICargoLink &l) const;
...
public:
	...
	int GetLineCount() const { return 1 + (int)link_list.size(); }
