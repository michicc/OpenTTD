...
static Foundation GetFoundation_Water(TileIndex tile, Tile *tptr, Slope tileh)
{
...
static void DoDryUp(TileIndex tile)
{
	...
	switch (GetTileType(tile)) {
		...
		case MP_WATER:
			...
			if (HasTileByType(tile, MP_TREES) || Command<CMD_LANDSCAPE_CLEAR>::Do(DC_EXEC, tile).Succeeded()) {
...
static TrackStatus GetTileTrackStatus_Water(TileIndex tile, Tile *tptr, TransportType mode, uint sub_mode, DiagDirection side)
{
...
static bool ClickTile_Water(TileIndex tile, Tile *tptr)
{
