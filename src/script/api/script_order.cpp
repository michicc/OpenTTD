...
/** Get the consist ID that corresponds to a given vehicle ID. */
static ConsistID VehicleIDToConsistID(VehicleID vehicle_id)
{
	return ::Vehicle::Get(vehicle_id)->GetConsist()->index;
}
...
/* static */ bool ScriptOrder::SetOrderJumpTo(VehicleID vehicle_id, OrderPosition order_position, OrderPosition jump_to)
{
	...
	return ScriptObject::Command<CMD_MODIFY_ORDER>::Do(0, VehicleIDToConsistID(vehicle_id), order_position, MOF_COND_DESTINATION, jump_to);
}
...
/* static */ bool ScriptOrder::SetOrderCondition(VehicleID vehicle_id, OrderPosition order_position, OrderCondition condition)
{
	...
	return ScriptObject::Command<CMD_MODIFY_ORDER>::Do(0, VehicleIDToConsistID(vehicle_id), order_pos, MOF_COND_VARIABLE, condition);
}
...
/* static */ bool ScriptOrder::SetOrderCompareFunction(VehicleID vehicle_id, OrderPosition order_position, CompareFunction compare)
{
	...
	int order_pos = ScriptOrderPositionToRealOrderPosition(vehicle_id, order_position);
	return ScriptObject::Command<CMD_MODIFY_ORDER>::Do(0, VehicleIDToConsistID(vehicle_id), order_pos, MOF_COND_COMPARATOR, compare);
}
...
/* static */ bool ScriptOrder::SetOrderCompareValue(VehicleID vehicle_id, OrderPosition order_position, SQInteger value)
{
	...
	int order_pos = ScriptOrderPositionToRealOrderPosition(vehicle_id, order_position);
	return ScriptObject::Command<CMD_MODIFY_ORDER>::Do(0, VehicleIDToConsistID(vehicle_id), order_pos, MOF_COND_VALUE, value);
}
...
/* static */ bool ScriptOrder::SetStopLocation(VehicleID vehicle_id, OrderPosition order_position, StopLocation stop_location)
{
	...
	int order_pos = ScriptOrderPositionToRealOrderPosition(vehicle_id, order_position);
	return ScriptObject::Command<CMD_MODIFY_ORDER>::Do(0, VehicleIDToConsistID(vehicle_id), order_pos, MOF_STOP_LOCATION, stop_location);
}
...
/* static */ bool ScriptOrder::SetOrderRefit(VehicleID vehicle_id, OrderPosition order_position, CargoID refit_cargo)
{
	...
	return ScriptObject::Command<CMD_ORDER_REFIT>::Do(0, VehicleIDToConsistID(vehicle_id), ScriptOrderPositionToRealOrderPosition(vehicle_id, ScriptOrder::ResolveOrderPosition(vehicle_id, order_position)), refit_cargo);
}
...
/* static */ bool ScriptOrder::InsertOrder(VehicleID vehicle_id, OrderPosition order_position, TileIndex destination, ScriptOrder::ScriptOrderFlags order_flags)
{
	...
	int order_pos = ScriptOrderPositionToRealOrderPosition(vehicle_id, order_position);
	return ScriptObject::Command<CMD_INSERT_ORDER>::Do(0, VehicleIDToConsistID(vehicle_id), order_pos, order);
}
...
/* static */ bool ScriptOrder::RemoveOrder(VehicleID vehicle_id, OrderPosition order_position)
{
	...
	int order_pos = ScriptOrderPositionToRealOrderPosition(vehicle_id, order_position);
	return ScriptObject::Command<CMD_DELETE_ORDER>::Do(0, VehicleIDToConsistID(vehicle_id), order_pos);
}
...
/* static */ bool ScriptOrder::SkipToOrder(VehicleID vehicle_id, OrderPosition next_order)
{
	...
	return ScriptObject::Command<CMD_SKIP_TO_ORDER>::Do(0, VehicleIDToConsistID(vehicle_id), order_pos);
}
...
/* static */ bool ScriptOrder::_SetOrderFlags()
{
	...
	ConsistID consist_id = VehicleIDToConsistID(vehicle_id);
	if ((current & OF_NON_STOP_FLAGS) != (order_flags & OF_NON_STOP_FLAGS)) {
		return ScriptObject::Command<CMD_MODIFY_ORDER>::Do(&::_DoCommandReturnSetOrderFlags, consist_id, order_pos, MOF_NON_STOP, order_flags & OF_NON_STOP_FLAGS);
	}
	...
	switch (order->GetType()) {
		case OT_GOTO_DEPOT:
			if ((current & OF_DEPOT_FLAGS) != (order_flags & OF_DEPOT_FLAGS)) {
				...
				return ScriptObject::Command<CMD_MODIFY_ORDER>::Do(&::_DoCommandReturnSetOrderFlags, consist_id, order_pos, MOF_DEPOT_ACTION, data);
			}
			break;

		case OT_GOTO_STATION:
			if ((current & OF_UNLOAD_FLAGS) != (order_flags & OF_UNLOAD_FLAGS)) {
				return ScriptObject::Command<CMD_MODIFY_ORDER>::Do(&::_DoCommandReturnSetOrderFlags, consist_id, order_pos, MOF_UNLOAD, (order_flags & OF_UNLOAD_FLAGS) >> 2);
			}
			if ((current & OF_LOAD_FLAGS) != (order_flags & OF_LOAD_FLAGS)) {
				return ScriptObject::Command<CMD_MODIFY_ORDER>::Do(&::_DoCommandReturnSetOrderFlags, consist_id, order_pos, MOF_LOAD, (order_flags & OF_LOAD_FLAGS) >> 5);
			}
			break;
...
/* static */ bool ScriptOrder::MoveOrder(VehicleID vehicle_id, OrderPosition order_position_move, OrderPosition order_position_target)
{
	...
	return ScriptObject::Command<CMD_MOVE_ORDER>::Do(0, VehicleIDToConsistID(vehicle_id), order_pos_move, order_pos_target);
}
...
/* static */ bool ScriptOrder::CopyOrders(VehicleID vehicle_id, VehicleID main_vehicle_id)
{
	...
	return ScriptObject::Command<CMD_CLONE_ORDER>::Do(0, CO_COPY, VehicleIDToConsistID(vehicle_id), VehicleIDToConsistID(main_vehicle_id));
}
...
/* static */ bool ScriptOrder::ShareOrders(VehicleID vehicle_id, VehicleID main_vehicle_id)
{
	...
	return ScriptObject::Command<CMD_CLONE_ORDER>::Do(0, CO_SHARE, VehicleIDToConsistID(vehicle_id), VehicleIDToConsistID(main_vehicle_id));
}
...
/* static */ bool ScriptOrder::UnshareOrders(VehicleID vehicle_id)
{
	...
	return ScriptObject::Command<CMD_CLONE_ORDER>::Do(0, CO_UNSHARE, VehicleIDToConsistID(vehicle_id), 0);
}
