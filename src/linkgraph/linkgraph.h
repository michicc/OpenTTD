...
public:
	...
	struct BaseNode {
		...
		void AddEdge(NodeID to, OrderID from_oid, OrderID to_oid, uint capacity, uint usage, uint32_t time, EdgeUpdateMode mode);
		void UpdateEdge(NodeID to, OrderID from_oid, OrderID to_oid, uint capacity, uint usage, uint32_t time, EdgeUpdateMode mode);
