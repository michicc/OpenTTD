 ...
 */
void LinkGraph::BaseNode::AddEdge(NodeID to, OrderID from_oid, OrderID to_oid, uint capacity, uint usage, uint32 travel_time, EdgeUpdateMode mode)
{
 ...
 * @param mode Update mode to be used.
 */
void LinkGraph::BaseNode::UpdateEdge(NodeID to, OrderID from_oid, OrderID to_oid, uint capacity, uint usage, uint32 travel_time, EdgeUpdateMode mode)
{
	assert(capacity > 0);
